...
(1, 'KRW-LINK', 'SELL', 15200, 10, 'COMPLETED'),
(1, 'KRW-KRW', 'BUY', 1, 152000, 'COMPLETED'),
(5, 'KRW-ATOM', 'BUY', 18100, 7, 'COMPLETED'),
(5, 'KRW-KRW', 'SELL', 1, 126700, 'COMPLETED'),
(2, 'KRW-SHIB', 'BUY', 0.44, 600000, 'COMPLETED'),
(2, 'KRW-KRW', 'SELL', 1, 264000, 'COMPLETED'),
(3, 'KRW-NEAR', 'SELL', 7520, 20, 'COMPLETED'),
(3, 'KRW-KRW', 'BUY', 1, 150400, 'COMPLETED'),
(4, 'KRW-LINK', 'BUY', 15050, 12, 'COMPLETED'),
(4, 'KRW-KRW', 'SELL', 1, 180600, 'COMPLETED'),
(1, 'KRW-ALGO', 'SELL', 610, 250, 'COMPLETED'),
(1, 'KRW-KRW', 'BUY', 1, 152500, 'COMPLETED'),
(5, 'KRW-DOT', 'BUY', 8480, 25, 'COMPLETED'),
(5, 'KRW-KRW', 'SELL', 1, 212000, 'COMPLETED'),
(2, 'KRW-SOL', 'BUY', 168000, 8, 'COMPLETED'),
(2, 'KRW-KRW', 'SELL', 1, 1344000, 'COMPLETED'),
(3, 'KRW-SHIB', 'SELL', 0.48, 400000, 'COMPLETED'),
(3, 'KRW-KRW', 'BUY', 1, 192000, 'COMPLETED'),
(4, 'KRW-POL', 'BUY', 1210, 150, 'COMPLETED'),
(4, 'KRW-KRW', 'SELL', 1, 181500, 'COMPLETED'),
(1, 'KRW-NEAR', 'BUY', 7480, 35, 'COMPLETED'),
(1, 'KRW-KRW', 'SELL', 1, 261800, 'COMPLETED'),
...
(5, 'KRW-LINK', 'SELL', 15300, 10, 'PENDING'),
(3, 'KRW-ALGO', 'BUY', 590, 400, 'PENDING'),
(2, 'KRW-SHIB', 'SELL', 0.49, 500000, 'PENDING'),
(4, 'KRW-XLM', 'SELL', 470, 800, 'PENDING');
