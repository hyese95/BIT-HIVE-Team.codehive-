...
VALUES 
-- 1단계: 원댓글만 먼저 삽입 (parent_no가 NULL인 댓글) - 날짜 오름차순으로 정렬

-- 2025-02-18 ~ 2025-02-28 게시글의 원댓글
...
INSERT INTO comments (post_no, user_no, parent_no, comment_cont, comment_created_at)
VALUES
-- 2025-02-18 ~ 2025-02-28 게시글의 대댓글
(27, 12, 2, '가격 상승 가능성 높아보입니다', '2025-02-18 22:40:27'),
(38, 34, 1, '화이트페이퍼 분석이 중요하죠', '2025-02-18 22:30:15'),
(9, 16, 3, '저도 참석하고 싶습니다', '2025-02-19 00:40:27'),
(20, 27, 4, '공포 탐욕 지수랑 비슷하네요', '2025-02-19 00:55:42'),
(1, 8, 5, '구체적인 프로젝트가 궁금해요', '2025-02-20 22:20:27'),

-- 2025-03-01 ~ 2025-03-05 게시글의 대댓글
(16, 26, 6, '다음 컨퍼런스는 언제인가요?', '2025-03-03 21:40:15'),
(5, 4, 7, '전략 공유 가능하신가요?', '2025-03-04 22:30:22'),

-- 2025-03-06 ~ 2025-03-10 게시글의 대댓글
(32, 40, 8, '거래량이 핵심이죠', '2025-03-11 11:45:12'),

-- 2025-03-11 ~ 2025-03-15 게시글의 대댓글
(10, 24, 10, '루머라던데 곧 공식 발표 있을 것 같아요', '2025-03-12 18:30:15'),
(6, 32, 12, '그만큼 시장이 안정화된거죠', '2025-03-13 12:30:15'),
(17, 14, 13, '저항선도 분석해주세요', '2025-03-13 17:40:27'),
(28, 36, 14, '단타는 진짜 실력자네요', '2025-03-13 21:50:15'),
(13, 6, 15, '확장성 문제 해결이 핵심이죠', '2025-03-14 13:40:27'),
(24, 28, 16, '월간 차트도 분석해주세요!', '2025-03-14 18:30:15'),
(35, 10, 17, '배수 조절이 중요합니다', '2025-03-15 00:20:27'),
(20, 20, 18, '패턴이 잘 보이네요', '2025-03-15 14:40:15'),
(31, 2, 19, '장기 투자가 답인 것 같아요', '2025-03-15 19:20:27'),

-- 2025-03-16 게시글의 대댓글
(27, 34, 20, '저도 2년째 존버 중입니다', '2025-03-16 11:45:12'),
(38, 16, 21, '가스비가 많이 줄었어요', '2025-03-16 17:40:33'),
(9, 38, 22, '기관 자금 유입이 관건이겠네요', '2025-03-16 21:30:22'),

-- 2025-03-17 게시글의 대댓글
(34, 40, 23, '추가 의견 있습니다', '2025-03-17 16:10:48'),
(34, 26, 23, '좋은 인사이트네요', '2025-03-17 18:25:22'),
(5, 22, 26, '모바일도 불안정해요', '2025-03-17 19:20:33'),
(5, 37, 26, '앱 최신 버전으로 업데이트 해보세요', '2025-03-17 20:15:48'),
(5, 19, 26, '저도 업데이트 하니까 괜찮아졌어요', '2025-03-17 21:40:22'),
(16, 30, 28, '신중한 접근이 필요해보입니다', '2025-03-18 01:15:27'),
(16, 1, 28, '보조지표도 같이 봐야겠네요', '2025-03-18 02:30:18'),

-- 2025-03-18 게시글의 대댓글
(1, 10, 29, '저도 동감입니다. 드디어 버틴 보람이 있네요', '2025-03-18 12:45:30'),
(1, 3, 29, '이제 시작입니다', '2025-03-18 14:25:12'),
(1, 11, 30, '흐름이 좋아보이네요', '2025-03-18 15:10:33'),
(12, 36, 32, '맞습니다. 이 패턴은 신뢰도가 높죠', '2025-03-18 18:30:15'),
(12, 33, 32, '추가 설명 부탁드립니다', '2025-03-18 19:45:33'),
(23, 18, 34, '저도 비슷한 경험 있습니다', '2025-03-18 23:15:27'),
(23, 15, 34, '리스크 관리가 중요하죠', '2025-03-19 00:30:40');
