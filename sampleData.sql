...
INSERT INTO users (user_id, password, nickname, email, phone, privacy_agreements, marketing_agreements,
                   gender, birth_date, name, self_introduction, role, profile_img_url, oauth)
VALUES ('user1', 'pass123', '비트맨', 'user1@example.com', '010-2222-0001', true, true, 'MALE', '1990-01-01', '김철수',
        '비트코인 장기투자자', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user2', 'pass123', '코인女', 'user2@example.com', '010-2222-0002', true, false,  'FEMALE', '1992-02-02',
        '이영희', '알트코인 단타 전문', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user3', 'pass123', '투자의신', 'user3@example.com', '010-2222-0003', true, true,  'MALE', '1988-03-03', '박민수',
        '3년차 존버중', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user4', 'pass123', '존버킹', 'user4@example.com', '010-2222-0004', true, true,  'MALE', '1995-04-04', '정대만',
        '존버는 승리한다', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user5', 'pass123', '단타여신', 'user5@example.com', '010-2222-0005', true, false,  'FEMALE', '1993-05-05',
        '최지은', '단타 전문', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user6', 'pass123', '코인요정', 'user6@example.com', '010-2222-0006', true, true,  'FEMALE', '1991-06-06',
        '송미라', '비트코인 마이너', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user7', 'pass123', '황소장', 'user7@example.com', '010-2222-0007', true, true,  'MALE', '1987-07-07', '황길동',
        '강세장 전문가', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user8', 'pass123', '곰돌이', 'user8@example.com', '010-2222-0008', true, false,  'MALE', '1994-08-08', '곽진태',
        '약세장 전문가', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user9', 'pass123', '알트하는여자', 'user9@example.com', '010-2222-0009', true, true,  'FEMALE', '1996-09-09',
        '한미영', '알트코인 분석가', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user10', 'pass123', '김코린이', 'user10@example.com', '010-2222-0010', true, true, 'MALE', '1997-10-10',
        '김초보', '열심히 공부중입니다', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user11', 'pass123', '이더리움맨', 'user11@example.com', '010-2222-0011', true, false, 'MALE', '1989-11-11',
        '이더훈', '이더리움 맥시멀리스트', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user12', 'pass123', '리플여신', 'user12@example.com', '010-2222-0012', true, true, 'FEMALE', '1990-12-12',
        '정리플', 'XRP 홀더', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user13', 'pass123', '도지코인러', 'user13@example.com', '010-2222-0013', true, true,  'MALE', '1992-01-13',
        '도지킴', '밈코인 전문가', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user14', 'pass123', '솔라나맨', 'user14@example.com', '010-2222-0014', true, false,  'MALE', '1993-02-14',
        '솔라김', 'SOL 마니아', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user15', 'pass123', '에이다여신', 'user15@example.com', '010-2222-0015', true, true, 'FEMALE', '1994-03-15',
        '에이박', 'ADA 장기투자', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user16', 'pass123', '폴카맨', 'user16@example.com', '010-2222-0016', true, true,  'MALE', '1995-04-16',
        '폴카최', 'DOT 홀더', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user17', 'pass123', '링크여신', 'user17@example.com', '010-2222-0017', true, false, 'FEMALE', '1996-05-17',
        '링크정', 'LINK 믿음홀더', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user18', 'pass123', '유니스왑킹', 'user18@example.com', '010-2222-0018', true, true,  'MALE', '1997-06-18',
        '유니양', 'UNI 장기투자', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user19', 'pass123', '테더지박령', 'user19@example.com', '010-2222-0019', true, true, 'MALE', '1998-07-19',
        '테더송', '스테이블코인 전문가', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user20', 'pass123', '메틱여신', 'user20@example.com', '010-2222-0020', true, false,  'FEMALE', '1999-08-20',
        '메틱임', 'MATIC 홀더', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user21', 'pass123', '코인초보', 'user21@example.com', '010-3333-0001', true, true, 'MALE', '1991-01-21',
        '초보김', '열심히 배우는 중', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user22', 'pass123', '투자신입', 'user22@example.com', '010-3333-0002', true, false, 'FEMALE', '1992-02-22',
        '신입이', '첫 투자 시작했어요', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user23', 'pass123', '블록체인맨', 'user23@example.com', '010-3333-0003', true, true, 'MALE', '1993-03-23',
        '블록박', '블록체인 기술에 관심많아요', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user24', 'pass123', '채굴러', 'user24@example.com', '010-3333-0004', true, true, 'MALE', '1994-04-24',
        '채굴김', '채굴 시작했어요', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user25', 'pass123', '스테이킹여신', 'user25@example.com', '010-3333-0005', true, false,  'FEMALE', '1995-05-25',
        '스테장', '스테이킹 수익률 좋아요', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user26', 'pass123', '디파이초보', 'user26@example.com', '010-3333-0006', true, true, 'MALE', '1996-06-26',
        '디파최', 'DeFi 공부중입니다', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user27', 'pass123', 'NFT수집가', 'user27@example.com', '010-3333-0007', true, true,  'MALE', '1997-07-27',
        '엔프트', 'NFT 컬렉터입니다', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user28', 'pass123', '메타버스킹', 'user28@example.com', '010-3333-0008', true, false,  'MALE', '1998-08-28',
        '메타김', '메타버스 관련주 투자', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user29', 'pass123', '레이어2여신', 'user29@example.com', '010-3333-0009', true, true,  'FEMALE', '1999-09-29',
        '레이박', '레이어2 프로젝트 관심있어요', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user30', 'pass123', '웹3맨', 'user30@example.com', '010-3333-0010', true, true,'MALE', '2000-10-30',
        '웹삼이', 'Web3.0 개발자입니다', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user31', 'pass123', '스마트컨트랙트', 'user31@example.com', '010-3333-0011', true, false, 'MALE', '1991-11-01',
        '스마정', '스마트컨트랙트 개발중', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user32', 'pass123', '토큰이코노미', 'user32@example.com', '010-3333-0012', true, true,  'FEMALE', '1992-12-02',
        '토큰양', '토큰이코노미 연구중', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user33', 'pass123', '거래소맨', 'user33@example.com', '010-3333-0013', true, true, 'MALE', '1993-01-03',
        '거래김', '거래소 API 개발자', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user34', 'pass123', '차트초보', 'user34@example.com', '010-3333-0014', true, false, 'MALE', '1994-02-04',
        '차트박', '차트 공부중이에요', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user35', 'pass123', '코딩하는투자자', 'user35@example.com', '010-3333-0015', true, true, 'MALE', '1995-03-05',
        '코딩이', '개발자겸 투자자입니다', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user36', 'pass123', '마진여신', 'user36@example.com', '010-3333-0016', true, true, 'FEMALE', '1996-04-06',
        '마진송', '마진거래 전문', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user37', 'pass123', '선물왕', 'user37@example.com', '010-3333-0017', true, false, 'MALE', '1997-05-07',
        '선물최', '선물거래 주력', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user38', 'pass123', '스윙맨', 'user38@example.com', '010-3333-0018', true, true, 'MALE', '1998-06-08',
        '스윙정', '스윙매매 전문', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user39', 'pass123', '스캘핑여신', 'user39@example.com', '010-3333-0019', true, true, 'FEMALE', '1999-07-09',
        '스캘프', '스캘핑 트레이더', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('user40', 'pass123', '포지션킹', 'user40@example.com', '010-3333-0020', true, false, 'MALE', '2000-08-10',
        '포지션', '포지션 트레이딩 전문', 'USER', '/img/user_icon/user_icon_default.png', NULL),
       ('admin1', '$2a$10$53qEoRhbGAbFOdBQOJQ7/.Kr./BTRkiVSSHy5Qni2syy8MtCtSON.', '나는관리자', 'admin10@example.com', '010-7777-7777', true, false, 'MALE', '1800-08-10',
        '최고존엄', '최고존엄', 'ADMIN', '/img/user_icon/user_icon_default.png', NULL);;
